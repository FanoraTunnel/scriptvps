...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/FanoraTunnel/scriptvps/main/ipsec"
...
touch /var/lib/FanoraTunnel/data-user-l2tp
touch /var/lib/FanoraTunnel/data-user-pptp
rm -f /root/ipsec.sh
